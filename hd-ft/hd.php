...
<head>
    ...
    <meta property="og:image" content="<?= (strpos($pageImage, 'http') === 0) ? $pageImage : BASE_URL . ltrim($pageImage, '/') ?>">
    <?php else: ?>
    <meta property="og:image" content="<?= BASE_URL ?>assets/img/logo/logo-bw.png">
    <?php endif; ?>
    ...
    <?php if(isset($pageImage) && !empty($pageImage)): ?>
    <meta property="twitter:image" content="<?= (strpos($pageImage, 'http') === 0) ? $pageImage : BASE_URL . ltrim($pageImage, '/') ?>">
    <?php endif; ?>
<body>
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto <?php if($nav === 'fondation'):?>active <?php endif; ?>" href="fondation/" target="_blank">Fondation</a></li>
